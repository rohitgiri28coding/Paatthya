...
import com.coaching.srit.data.uievent.home.Review
...
class ResultViewModel: ViewModel() {
    val reviewSamples = listOf(
        ...
        Review(
            review = "I have been trying to find a good course on Web development for a very long time, both online and offline. But the courses that I liked were not up to date. Finally found a perfect course for it in SRIT Computer Classes. Really enjoying your way of Explaining Concepts Sir.",
            name = "Abhishek",
            designation = "           B.Tech",
